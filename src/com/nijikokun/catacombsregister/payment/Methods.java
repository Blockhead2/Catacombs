package com.nijikokun.catacombsregister.payment;
...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.nijikokun.catacombsregister.payment.methods.iCo6());
        addMethod("iConomy", new com.nijikokun.catacombsregister.payment.methods.iCo5());
        addMethod("iConomy", new com.nijikokun.catacombsregister.payment.methods.iCo4());
        addMethod("BOSEconomy", new com.nijikokun.catacombsregister.payment.methods.BOSE6());
        addMethod("BOSEconomy", new com.nijikokun.catacombsregister.payment.methods.BOSE7());
        addMethod("Essentials", new com.nijikokun.catacombsregister.payment.methods.EE17());
        addMethod("Currency", new com.nijikokun.catacombsregister.payment.methods.MCUR());
    ...
    public static boolean setPreferred(String check) {
      ...
      //      System.out.println(" set preferred="+check);
            preferred = check;
            return true;
        }
